...
cuh2vizR_get_energy_df(dfCon, hcu_dists =  seq(-0.05, 5, length.out=50), seq(0.3, 3, length.out=50))->dfx
# Or
# cuh2_scan_grid(dfCon$atom_data, hcu_dists =  seq(-0.05, 5, length.out=50), seq(0.3, 3, length.out=50))->dfx
